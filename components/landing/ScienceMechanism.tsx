      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {mechanisms.map((item, index) => (
            <div key={index} className="flex flex-col items-center text-center p-6 rounded-2xl bg-white border border-gray-200 transition-colors hover:bg-gray-50">
              <div className="h-16 w-16 rounded-2xl bg-green-50 flex items-center justify-center text-primary mb-6">
        ...
        <div className="mt-16 rounded-3xl bg-gray-900 p-8 md:p-12 text-center text-white overflow-hidden relative">
